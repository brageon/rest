...
Misc files: helper, zeta, zipf, meshgrid, overlay, embed*. Matrix files: zscore, brute, helper, line-count, svm, kde, row-sums, means, eigen, symmetry. Data wrangling: stops, du, dell*, range. Match: pattern*, occur, find-gaps, rms-index, highscore, diffevol*, entity, harmony, optima. Rest: ranking, frequency, unit*, sentence, words, random, gaussian, combine, chunking, brute. Old: emails*, csv-list, cosine-folder. Oak: bond2.js, bond.html. Left: nowhite, probal, youth, sum, wco.  

Strategies I have tested until glove embeddings. 1) energy_bids.csv to wordlists (dam, dan, eno) from bag-of-words. 2) matrix arithmetic to svm. 3) frequency table to represent 1/6 samples. 4) probability score direct from ranks to trigram distribution: AU 29 %, Rockford 34 %, Nig 41 %. Not consistent. 

Strategies is research and when it is logical consistent it will be science. After that it will be engineering like numpy. 
