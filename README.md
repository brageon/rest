...
Strategies I have tested until glove embeddings. 1) energy_bids.csv to wordlists (dam, dan, eno) from bag-of-words. 2) matrix arithmetic to svm. 3) frequency table to represent 1/6 samples. 4) probability score direct from ranks to trigram distribution: AU 29 %, Rockford 34 %, Nig 41 %. Not consistent. It is research and when it is logical consistent it will be science. After that it will be engineering like numpy. 
