...
input_text = "In short I have opt-out signature and data erasure through a third party holder. By being patient and valuing trust, I can ensure you don't look bad."
def remove_non(text):
